...
- new measures that are based on a clear conception of trust:
  ...
  - new: trust as a three-part relationship; .cyan[A trusts B with X] 
...
- .cyan[latent dirichlet allocation (LDA)] <br> = one popular topic modeling technique; .cyan[goal]: to assign each text as a mixture over latent topics
]
...
# Hypotheses
  ...
  - H4: The .cyan[number of associated topics] is .cyan[lower] for trust in “strangers” .cyan[when survey measures include a description of situation]. 
...
- new situative trust measures that asks for specific strangers and specific matters (e.g. a total stranger in the airport scenario) $\rightarrow$ A trusts B with X
